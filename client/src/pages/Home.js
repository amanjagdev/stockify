    ...
    <div className="Home">
      <div className="header">
        <div className="left">
          ...
          <p>
            Store your warehouse stocks and get an all-automated stockholder registry, with complete
            security. The Stockify gives you a platform where you can interact and manage your
            stocks.
          </p>
      ...
      <div className="main-body">
        ...
        <div className="about-us">
          ...
          <div className="items">
            <div className="item">
              <img
                src="https://avatars2.githubusercontent.com/u/34389172?s=460&u=be5a1c2e6df7ee4f36733f6b34cb300b8436fcb6&v=4"
                height="300px"
                width="300px"
                alt=""
              />
            ...
            <div className="item">
              <img
                src="https://avatars1.githubusercontent.com/u/24389474?s=460&u=6acb7c101d45df0ae75f95ab9c3b46a6cb16f211&v=4"
                height="300px"
                width="300px"
                alt=""
              />
